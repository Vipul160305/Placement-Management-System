      ...
      <div className="w-full max-w-[380px]">
        ...
        {!token ? (
          <div className="card text-center py-8">
            <p className="text-sm text-red-500 mb-3">Invalid or missing reset token.</p>
          ...
          <div className="card text-center py-8 space-y-3">
            ...
            <h2 className="font-manrope font-bold text-xl text-gray-900">Password updated!</h2>
            <p className="text-sm text-gray-500">Your password has been reset successfully.</p>
            <Link to="/login" className="text-sm text-primary font-medium hover:underline block mt-2">Back to login</Link>
          </div>
        ) : (
          <>
            <div className="mb-7">
              <h2 className="font-manrope font-bold text-2xl text-gray-900">Set new password</h2>
              <p className="text-gray-400 text-sm mt-1.5">Choose a strong password for your account.</p>
            </div>
